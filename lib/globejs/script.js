 ...
 * Address:
 *   Paying to a Globe address which is the hash of a pubkey.
...
Script.prototype.simpleOutHash = function ()
{
  ...
  case 'Pubkey':
    return Globe.Util.sha256ripe160(this.chunks[0]);
  default:
...
Script.prototype.getInType = function ()
{
  if (this.chunks.length == 1 &&
      Globe.Util.isArray(this.chunks[0])) {
...
Script.prototype.simpleInPubKey = function ()
{
  ...
  case 'Pubkey':
    ...
    //       See https://globetalk.org/?topic=6430.0
...
/**
 * Extract globe addresses from an output script
 */
