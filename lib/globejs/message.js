/// Implements Globe's feature for signing arbitrary messages.
...
Message.magicPrefix = "Globe Signed Message:\n";
...
Message.signMessage = function (key, message, compressed) {
  ...
  var address = key.getGlobeAddress().toString();
...
Message.verifyMessage = function (address, sig, message) {
  ...
  var expectedAddress = pubKey.getGlobeAddress().toString();
